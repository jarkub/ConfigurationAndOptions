...
public class IOptionsMonitorPatternModel : PageModel
{
    ...
    public IOptionsMonitorPatternModel(IOptionsMonitor<PositionOptions> optionsDelegate, IConfiguration configuration, ILogger<TestModel> _logger)
    {
    ...
    public PageResult OnGet()
    {
        ...
        Message = $"<br>Title: {_optionsDelegate.CurrentValue.Title} " +
                       $"<br>Name: {_optionsDelegate.CurrentValue.Name}";
