...
public class PositionOptionsWithConfigurationKeyNameModel : PageModel
{
    ...
    private readonly PositionOptionsWithConfigurationKeyName _options;
    ...
    public PositionOptionsWithConfigurationKeyNameModel(IOptions<PositionOptionsWithConfigurationKeyName> options, IConfiguration configuration, ILogger<TestModel> _logger)
    {
